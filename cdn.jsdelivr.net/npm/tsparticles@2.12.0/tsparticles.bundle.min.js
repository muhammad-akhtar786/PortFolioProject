/*! For license information please see tsparticles.bundle.min.js.LICENSE.txt */ ! function(t, e) {
    ...
    class v {
        ...
        rotate(t) {
            return v.create(this.x * Math.cos(t) - this.y * Math.sin(t), this.x * Math.sin(t) + this.y * Math.cos(t), 0)
        }
        setTo(t) {
            this.x = t.x, this.y = t.y;
            const e = t;
    ...
    function W(t) {
        U.debug = t.debug || U.debug, U.error = t.error || U.error, U.info = t.info || U.info, U.log = t.log || U.log, U.verbose = t.verbose || U.verbose, U.warning = t.warning || U.warning
    }
    ...
    function ct(t) {
        return {
            ...
            mass: t.getMass(),
            velocity: t.velocity,
            factor: m.create(T(t.options.bounce.horizontal), T(t.options.bounce.vertical))
        }
    }
        ...
        if (s.enable) {
            ...
            switch (s.startValue) {
                ...
                case "max":
                    ...
                    break;
                default:
                    o.value = M(o), t && (o.status = _() >= .5 ? "increasing" : "decreasing")
            }
        }
    ...
    class zt {
        ...
        static create(t, e) {
            const i = new zt;
            return i.load(t), void 0 !== e && (bt(e) || kt(e) ? i.load({
                value: e
            }) : i.load(e)), i
        }
        load(t) {
    ...
    class Mt {
        ...
        load(t) {
            t && (void 0 !== t.count && (this.count = O(t.count)), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.speed && (this.speed = O(t.speed)), void 0 !== t.decay && (this.decay = O(t.decay)), void 0 !== t.delay && (this.delay = O(t.delay)), void 0 !== t.sync && (this.sync = t.sync))
        }
    }
    class Pt extends Mt {
        constructor() {
    ...
    class St {
        ...
        load(t) {
            t && (gt(t.random) ? this.random.enable = t.random : this.random.load(t.random), void 0 !== t.value && (this.value = O(t.value, this.random.enable ? this.random.minimumValue : void 0)))
        }
    }
    class Ot extends St {
        constructor() {
    ...
    class Tt extends Ot {
        ...
        load(t) {
            if (super.load(t), !t) return;
            void 0 !== (t.animation ? ? t.anim) && (this.value = O(this.value, this.animation.enable ? this.animation.minimumValue : void 0))
        }
    }
    class Rt {
        constructor() {
    ...
    class Dt extends St {
        ...
        load(t) {
            t && (super.load(t), void 0 !== t.density && (this.density = t.density), wt(t.limit) ? this.limit.radius = t.limit : this.limit.load(t.limit))
        }
    }
    class Et {
        constructor() {
            this.color = new zt, this.color.value = "#000000", this.draggable = !1, this.opacity = 1, this.destroy = !0, this.orbits = !1, this.size = new Dt
        }
        load(t) {
            void 0 !== t && (void 0 !== t.color && (this.color = zt.create(this.color, t.color)), void 0 !== t.draggable && (this.draggable = t.draggable), this.name = t.name, void 0 !== t.opacity && (this.opacity = t.opacity), void 0 !== t.position && (this.position = {}, void 0 !== t.position.x && (this.position.x = O(t.position.x)), void 0 !== t.position.y && (this.position.y = O(t.position.y))), void 0 !== t.size && this.size.load(t.size), void 0 !== t.destroy && (this.destroy = t.destroy), void 0 !== t.orbits && (this.orbits = t.orbits))
        }
    }
    const It = "random",
        Lt = "mid",
    ...
    function Nt(t) {
        ...
        if (i.s) {
            const t = i.l < .5 ? i.l * (1 + i.s) : i.l + i.s - i.l * i.s,
                s = 2 * i.l - t;
            e.r = Bt(s, t, i.h + 1 / 3), e.g = Bt(s, t, i.h), e.b = Bt(s, t, i.h - 1 / 3)
    ...
    function Qt(t, e, i, s) {
        let o = t,
            n = e;
        return void 0 === o.r && (o = Nt(t)), void 0 === n.r && (n = Nt(e)), {
            b: z(o.b, n.b, i, s),
            g: z(o.g, n.g, i, s),
            r: z(o.r, n.r, i, s)
        }
    ...
    class oe {
        constructor(t, e, i, s) {
            this.absorbers = t, this.container = e, this._calcPosition = () => {
                ...
                if (this.options.orbits) {
                    if (void 0 === t.absorberOrbit && (t.absorberOrbit = m.create(0, 0), t.absorberOrbit.length = D(t.getPosition(), this.position), t.absorberOrbit.angle = _() * Math.PI * 2), t.absorberOrbit.length <= this.size && !this.options.destroy) {
                        const e = Math.min(s.width, s.height);
                        t.absorberOrbit.length = e * (.2 * _() - .1 + 1)
                    }
                    ...
                    t.position.x = this.position.x + o * r.x(n), t.position.y = this.position.y + o * r.y(n), t.absorberOrbit.length -= e.length, t.absorberOrbit.angle += (t.retina.moveSpeed ? ? 0) * i.retina.pixelRatio / 100 * i.retina.reduceFactor
                } else {
                    const i = m.origin;
                    i.length = e.length, i.angle = e.angle, t.velocity.addTo(i)
                }
            }, this.initialPosition = s ? m.create(s.x, s.y) : void 0, i instanceof Et ? this.options = i : (this.options = new Et, this.options.load(i)), this.dragging = !1, this.name = this.options.name, this.opacity = this.options.opacity, this.size = P(this.options.size.value) * e.retina.pixelRatio, this.mass = this.size * this.options.size.density * e.retina.reduceFactor;
        ...
        attract(t) {
            ...
            if (i.draggable) {
                ...
                if (t.clicking && t.downPosition) {
                    D(this.position, t.downPosition) <= this.size && (this.dragging = !0)
        ...
        draw(t) {
            t.translate(this.position.x, this.position.y), t.beginPath(), t.arc(0, 0, this.size, 0, 2 * Math.PI, !1), t.closePath(), t.fillStyle = Jt(this.color, this.opacity), t.fill()
        }
        resize() {
            const t = this.initialPosition;
            this.position = t && tt(t, this.container.canvas.size, m.origin) ? t : this._calcPosition()
        }
    }
    class ne {
        constructor(t) {
            this.container = t, this.array = [], this.absorbers = [], this.interactivityAbsorbers = [], t.getAbsorber = t => void 0 === t || wt(t) ? this.array[t || 0] : this.array.find((e => e.name === t)), t.addAbsorber = (t, e) => this.addAbsorber(t, e)
        }
        addAbsorber(t, e) {
        ...
        async init() {
            this.absorbers = this.container.actualOptions.absorbers, this.interactivityAbsorbers = this.container.actualOptions.interactivity.modes.absorbers, dt(this.absorbers, (t => {
                this.addAbsorber(t)
            }))
        }
        particleUpdate(t) {
    ...
    class ae {
        ...
        loadOptions(t, e) {
            (this.needsPlugin(t) || this.needsPlugin(e)) && (e ? .absorbers && (t.absorbers = dt(e.absorbers, (t => {
                const e = new Et;
                return e.load(t), e
            }))), t.interactivity.modes.absorbers = dt(e ? .interactivity ? .modes ? .absorbers, (t => {
                const e = new Et;
                return e.load(t), e
            })))
        }
        needsPlugin(t) {
            if (!t) return !1;
            const e = t.absorbers;
            return kt(e) ? !!e.length : !!e || !(!t.interactivity ? .events ? .onClick ? .mode || !J("absorber", t.interactivity.events.onClick.mode))
        }
    }
    class re {
        load(t) {
            t && (void 0 !== t.bottom && (this.bottom = O(t.bottom)), void 0 !== t.left && (this.left = O(t.left)), void 0 !== t.right && (this.right = O(t.right)), void 0 !== t.top && (this.top = O(t.top)))
        }
    }
    class ce extends St {
        constructor() {
    ...
    class he {
        constructor() {
            this.count = 1, this.factor = new ce, this.rate = new le, this.sizeOffset = !0
        }
        load(t) {
            t && (void 0 !== t.color && (this.color = zt.create(this.color, t.color)), void 0 !== t.count && (this.count = t.count), this.factor.load(t.factor), this.rate.load(t.rate), this.particles = dt(t.particles, (t => st({}, t))), void 0 !== t.sizeOffset && (this.sizeOffset = t.sizeOffset), t.colorOffset && (this.colorOffset = this.colorOffset ? ? {}, void 0 !== t.colorOffset.h && (this.colorOffset.h = t.colorOffset.h), void 0 !== t.colorOffset.s && (this.colorOffset.s = t.colorOffset.s), void 0 !== t.colorOffset.l && (this.colorOffset.l = t.colorOffset.l)))
        }
    }
    class de {
        constructor() {
    ...
    class ue {
        ...
        load(t) {
            t && (void 0 !== t.count && (this.count = O(t.count)), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.offset && (this.offset = O(t.offset)), void 0 !== t.speed && (this.speed = O(t.speed)), void 0 !== t.decay && (this.decay = O(t.decay)), void 0 !== t.delay && (this.delay = O(t.delay)), void 0 !== t.sync && (this.sync = t.sync))
        }
    }
    class pe {
        constructor() {
    ...
    class be {
        constructor() {
            this.absorb = new ve, this.bounce = new ge, this.enable = !1, this.maxSpeed = 50, this.mode = "bounce", this.overlap = new me
        }
        load(t) {
            t && (this.absorb.load(t.absorb), this.bounce.load(t.bounce), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.maxSpeed && (this.maxSpeed = O(t.maxSpeed)), void 0 !== t.mode && (this.mode = t.mode), this.overlap.load(t.overlap))
        }
    }
    class we {
        constructor() {
        ...
        load(t) {
            t && (void 0 !== t.offset && (this.offset = O(t.offset)), void 0 !== t.value && (this.value = O(t.value)))
        }
    }
    class xe {
        constructor() {
        ...
        load(t) {
            if (!t) return;
            void 0 !== t.distance && (this.distance = O(t.distance)), void 0 !== t.enable && (this.enable = t.enable);
    ...
    class ke {
        ...
        load(t) {
            t && (void 0 !== t.acceleration && (this.acceleration = O(t.acceleration)), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.inverse && (this.inverse = t.inverse), void 0 !== t.maxSpeed && (this.maxSpeed = O(t.maxSpeed)))
        }
    }
    class ze {
        constructor() {
    ...
    class Me {
        load(t) {
            t && (void 0 !== t.color && (this.color = zt.create(this.color, t.color)), void 0 !== t.image && (this.image = t.image))
        }
    }
    class Pe {
        constructor() {
    ...
    class Se {
        ...
        load(t) {
            t && (void 0 !== t.acceleration && (this.acceleration = O(t.acceleration)), void 0 !== t.enable && (this.enable = t.enable), t.position && (this.position = st({}, t.position)))
        }
    }
    class Oe {
        constructor() {
            this.angle = new we, this.attract = new xe, this.center = new _e, this.decay = 0, this.distance = {}, this.direction = "none", this.drift = 0, this.enable = !1, this.gravity = new ke, this.path = new ze, this.outModes = new Ce, this.random = !1, this.size = !1, this.speed = 2, this.spin = new Se, this.straight = !1, this.trail = new Pe, this.vibrate = !1, this.warp = !1
        }
        get bounce() {
        ...
        load(t) {
            if (!t) return;
            this.angle.load(wt(t.angle) ? {
                value: t.angle
            } : t.angle), this.attract.load(t.attract), this.center.load(t.center), void 0 !== t.decay && (this.decay = O(t.decay)), void 0 !== t.direction && (this.direction = t.direction), void 0 !== t.distance && (this.distance = wt(t.distance) ? {
                horizontal: t.distance,
                vertical: t.distance
            } : { ...t.distance
            }), void 0 !== t.drift && (this.drift = O(t.drift)), void 0 !== t.enable && (this.enable = t.enable), this.gravity.load(t.gravity);
            const e = t.outModes ? ? t.outMode ? ? t.out_mode;
            void 0 !== e && (_t(e) ? this.outModes.load(e) : this.outModes.load({
                default: e
            })), this.path.load(t.path ? ? t.noise), void 0 !== t.random && (this.random = t.random), void 0 !== t.size && (this.size = t.size), void 0 !== t.speed && (this.speed = O(t.speed)), this.spin.load(t.spin), void 0 !== t.straight && (this.straight = t.straight), this.trail.load(t.trail), void 0 !== t.vibrate && (this.vibrate = t.vibrate), void 0 !== t.warp && (this.warp = t.warp)
        }
    }
    class Te extends Pt {
        constructor() {
    ...
    class Re extends St {
        constructor() {
            super(), this.animation = new Te, this.random.minimumValue = .1, this.value = 1
        }
        get anim() {
            return this.animation
        }
        ...
        load(t) {
            ...
            super.load(t);
            const e = t.animation ? ? t.anim;
            void 0 !== e && (this.animation.load(e), this.value = O(this.value, this.animation.enable ? this.animation.minimumValue : void 0))
        }
    }
    class De {
        constructor() {
    ...
    class Ie {
        constructor() {
            this.blur = 0, this.color = new zt, this.enable = !1, this.offset = {
                x: 0,
                y: 0
            }, this.color.value = "#000"
        }
        load(t) {
            t && (void 0 !== t.blur && (this.blur = t.blur), this.color = zt.create(this.color, t.color), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.offset && (void 0 !== t.offset.x && (this.offset.x = t.offset.x), void 0 !== t.offset.y && (this.offset.y = t.offset.y)))
        }
    }
    const Le = "character",
        Ae = "char",
    ...
    class He {
        ...
        load(t) {
            ...
            this.loadShape(t.character, Le, Ae, !0), this.loadShape(t.polygon, qe, Ve, !1), this.loadShape(t.image ? ? t.images, Fe, Be, !0), void 0 !== t.close && (this.close = t.close), void 0 !== t.fill && (this.fill = t.fill), void 0 !== t.type && (this.type = t.type)
        }
    }
    class Ue extends Pt {
        constructor() {
    ...
    class We extends St {
        constructor() {
            super(), this.animation = new Ue, this.random.minimumValue = 1, this.value = 3
        }
        get anim() {
            return this.animation
        }
    ...
    class $e {
        ...
        load(t) {
            t && (void 0 !== t.color && (this.color = fe.create(this.color, t.color)), void 0 !== t.width && (this.width = O(t.width)), void 0 !== t.opacity && (this.opacity = O(t.opacity)))
        }
    }
    class Ge extends St {
        constructor() {
    ...
    class je {
        constructor(t, e) {
            this._engine = t, this._container = e, this.bounce = new ge, this.collisions = new be, this.color = new fe, this.color.value = "#fff", this.groups = {}, this.move = new Oe, this.number = new Ee, this.opacity = new Re, this.reduceDuplicates = !1, this.shadow = new Ie, this.shape = new He, this.size = new We, this.stroke = new $e, this.zIndex = new Ge
        }
        load(t) {
            if (!t) return;
    ...
    function Ye(t, e, i, s) {
        ...
        }), wt(a.size.value) ? a.size.value /= r : (a.size.value.min /= r, a.size.value.max /= r), a.load(s);
        const l = n.sizeOffset ? O(-i.size.value, i.size.value) : 0,
            h = {
                x: i.position.x + M(l),
                y: i.position.y + M(l)
            };
        return e.particles.addParticle(h, a, i.group, (t => !(t.size.value < .5) && (t.velocity.length = M(O(i.velocity.length, t.velocity.length)), t.splitCount = (i.splitCount ? ? 0) + 1, t.unbreakable = !0, setTimeout((() => {
            t.unbreakable = !1
        }), 500), !0)))
    }
    class Je {
        ...
        init(t) {
            ...
            o && (c.bottom = P(o) * l.height / 100), n && (c.left = P(n) * l.width / 100), a && (c.right = P(a) * l.width / 100), r && (c.top = P(r) * l.height / 100)
        }
        isEnabled(t) {
            return !t.destroyed
        }
    ...
    class Ze {
        randomPosition(t, e, i) {
            ...
            })(s, o), a = (h = n, (c = s) * (l = o) / Math.sqrt((l * Math.cos(h)) ** 2 + (c * Math.sin(h)) ** 2)), r = i ? a * Math.sqrt(_()) : a;
            var c, l, h;
            return {
                x: t.x + r * Math.cos(n),
                y: t.y + r * Math.sin(n)
    ...
    class Qe {
        ...
        load(t) {
            t && (void 0 !== t.count && (this.count = t.count), void 0 !== t.delay && (this.delay = O(t.delay)), void 0 !== t.duration && (this.duration = O(t.duration)), void 0 !== t.wait && (this.wait = t.wait))
        }
    }
    class Ke {
        constructor() {
        ...
        load(t) {
            void 0 !== t && (void 0 !== t.quantity && (this.quantity = O(t.quantity)), void 0 !== t.delay && (this.delay = O(t.delay)))
        }
    }
    class ti {
        constructor() {
    ...
    class ei {
        constructor() {
            this.autoPlay = !0, this.fill = !0, this.life = new Qe, this.rate = new Ke, this.shape = "square", this.startCount = 0
        }
        load(t) {
            t && (void 0 !== t.autoPlay && (this.autoPlay = t.autoPlay), void 0 !== t.size && (this.size || (this.size = new ti), this.size.load(t.size)), void 0 !== t.direction && (this.direction = t.direction), this.domId = t.domId, void 0 !== t.fill && (this.fill = t.fill), this.life.load(t.life), this.name = t.name, this.particles = dt(t.particles, (t => st({}, t))), this.rate.load(t.rate), void 0 !== t.shape && (this.shape = t.shape), void 0 !== t.position && (this.position = {}, void 0 !== t.position.x && (this.position.x = O(t.position.x)), void 0 !== t.position.y && (this.position.y = O(t.position.y))), void 0 !== t.spawnColor && (void 0 === this.spawnColor && (this.spawnColor = new fe), this.spawnColor.load(t.spawnColor)), void 0 !== t.startCount && (this.startCount = t.startCount))
        }
    }
    class ii {
        constructor(t, e, i, s, o) {
            ...
            }, this._engine = t, this._currentDuration = 0, this._currentEmitDelay = 0, this._currentSpawnDelay = 0, this._initialPosition = o, s instanceof ei ? this.options = s : (this.options = new ei, this.options.load(s)), this._spawnDelay = 1e3 * P(this.options.life.delay ? ? 0) / this.container.retina.reduceFactor, this.position = this._initialPosition ? ? this._calcPosition(), this.name = this.options.name, this._shape = this._engine.emitterShapeManager ? .getShape(this.options.shape), this.fill = this.options.fill, this._firstSpawn = !this.options.life.wait, this._startParticlesAdded = !1;
            let n = st({}, this.options.particles);
            n ? ? = {}, n.move ? ? = {}, n.move.direction ? ? = this.options.direction, this.options.spawnColor && (this.spawnColor = Wt(this.options.spawnColor)), this._paused = !this.options.autoPlay, this._particlesOptions = n, this.size = this.options.size ? ? (() => {
                const t = new ti;
                return t.load({
                    height: 0,
                    mode: "percent",
        ...
        update(t) {
            this._paused || (this._firstSpawn && (this._firstSpawn = !1, this._currentSpawnDelay = this._spawnDelay ? ? 0, this._currentEmitDelay = this._emitDelay ? ? 0), this._startParticlesAdded || (this._startParticlesAdded = !0, this._emitParticles(this.options.startCount)), void 0 !== this._duration && (this._currentDuration += t.value, this._currentDuration >= this._duration && (this.pause(), void 0 !== this._spawnDelay && delete this._spawnDelay, this._immortal || this._lifeCount--, this._lifeCount > 0 || this._immortal ? (this.position = this._calcPosition(), this._spawnDelay = 1e3 * P(this.options.life.delay ? ? 0) / this.container.retina.reduceFactor) : this._destroy(), this._currentDuration -= this._duration, delete this._duration)), void 0 !== this._spawnDelay && (this._currentSpawnDelay += t.value, this._currentSpawnDelay >= this._spawnDelay && (this._engine.dispatchEvent("emitterPlay", {
                container: this.container
    ...
    class si {
        constructor(t, e) {
            this.container = e, this._engine = t, this.array = [], this.emitters = [], this.interactivityEmitters = {
                ...
                value: []
            }, e.getEmitter = t => void 0 === t || wt(t) ? this.array[t || 0] : this.array.find((e => e.name === t)), e.addEmitter = (t, e) => this.addEmitter(t, e), e.removeEmitter = t => {
    ...
    class ci {
        ...
        loadOptions(t, e) {
            ...
            if (i)
                if (kt(i)) t.interactivity.modes.emitters = {
                    random: {
                        count: 1,
                        enable: !0
                    },
                    ...
                    const e = i;
                    if (void 0 !== e.value)
                        if (kt(e.value)) t.interactivity.modes.emitters = {
                            random: {
        ...
        needsPlugin(t) {
            if (!t) return !1;
            const e = t.emitters;
            return kt(e) && !!e.length || void 0 !== e || !!t.interactivity ? .events ? .onClick ? .mode && J("emitter", t.interactivity.events.onClick.mode)
        }
    }
    class li {
        constructor(t) {
    ...
    class hi {
        ...
        load(t) {
            t && (void 0 !== t.delay && (this.delay = t.delay), void 0 !== t.quantity && (this.quantity = t.quantity), void 0 !== t.particles && (this.particles = st({}, t.particles)), void 0 !== t.pauseOnStop && (this.pauseOnStop = t.pauseOnStop))
        }
    }
    class di extends li {
        constructor(t) {
        ...
        isEnabled(t) {
            ...
            return s.clicking && s.inside && !!s.position && J("trail", o.onClick.mode) || s.inside && !!s.position && J("trail", o.onHover.mode)
        }
        loadModeOptions(t, ...e) {
    ...
    class ui {
        ...
        load(t) {
            t && (void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.value && (this.value = O(t.value)))
        }
    }
    class pi {
        constructor() {
            this.darken = new ui, this.enable = !1, this.enlighten = new ui, this.mode = "vertical", this.speed = 25
        }
        load(t) {
            t && (void 0 !== t.backColor && (this.backColor = zt.create(this.backColor, t.backColor)), this.darken.load(t.darken), void 0 !== t.enable && (this.enable = t.enable), this.enlighten.load(t.enlighten), void 0 !== t.mode && (this.mode = t.mode), void 0 !== t.speed && (this.speed = O(t.speed)))
        }
    }
    class fi {
            ...
            ! function(t) {
                ...
                if (e ? .enable)
                    if (t.roll = {
                            ...
                            angle: _() * Math.PI * 2,
                            speed: P(e.speed) / 360
                        }, e.backColor) t.backColor = Wt(e.backColor);
    ...
    function wi(t) {
        ...
        i.setTransform(m.a, m.b, m.c, m.d, u.x, u.y), i.beginPath(), a && (i.globalCompositeOperation = r);
        const y = s.shadowColor;
        h.enable && y && (i.shadowBlur = h.blur, i.shadowColor = Jt(y), i.shadowOffsetX = h.offset.x, i.shadowOffsetY = h.offset.y), n.fill && (i.fillStyle = n.fill);
        const g = s.strokeWidth ? ? 0;
        i.lineWidth = g, n.stroke && (i.strokeStyle = n.stroke), xi(e, i, s, c, l, o), g > 0 && i.stroke(), s.close && i.closePath(), s.fill && i.fill(), _i(e, i, s, c, l, o), i.globalCompositeOperation = "source-over", i.setTransform(1, 0, 0, 1, 0, 0)
    }
    ...
    class Ci {
        constructor(t) {
            this.container = t, this._applyPostDrawUpdaters = t => {
                ...
                for (const s of this._colorPlugins)
                    if (!e && s.particleFillColor && (e = Wt(s.particleFillColor(t))), !i && s.particleStrokeColor && (i = Wt(s.particleStrokeColor(t))), e && i) break;
                return [e, i]
            }, this._initCover = () => {
        ...
        clear() {
            const t = this.container.actualOptions,
                e = t.particles.move.trail,
                i = this._trailFill;
            t.backgroundMask.enable ? this.paint() : e.enable && e.length > 0 && i ? i.color ? this._paintBase(Jt(i.color, i.opacity)) : i.image && this._paintImage(i.image, i.opacity) : this.draw((t => {
                bi(t, this.size)
            }))
        }
        destroy() {
        ...
        drawParticle(t, e) {
            ...
            n || (n = s), a || (a = o), (n || a) && this.draw((s => {
                const o = this.container,
                    ...
                    p = {},
                    f = {
                        fill: n ? Zt(n, d) : void 0
                    };
                f.stroke = a ? Zt(a, u) : f.fill, this._applyPreDrawUpdaters(s, t, i, d, f, p), wi({
                    container: o,
                    context: s,
                    particle: t,
                    delta: e,
        ...
        paint() {
            const t = this.container.actualOptions;
            this.draw((e => {
                t.backgroundMask.enable && t.backgroundMask.cover ? (bi(e, this.size), this._paintBase(this._coverColorStyle)) : this._paintBase()
            }))
        }
        resize() {
        ...
        stop() {
            this._safeMutationObserver((t => t.disconnect())), this._mutationObserver = void 0, this.draw((t => bi(t, this.size)))
        }
        async windowResize() {
    ...
    class Oi {
        constructor(t) {
            this.container = t, this._doMouseTouchClick = t => {
                ...
                const p = u,
                    f = n.canvas.element;
                f && (f.style.pointerEvents = p === f ? "initial" : "none"), (a.interactivity.events.onHover.enable || a.interactivity.events.onClick.enable) && (Si(u, r, i.mouseMove, e), Si(u, c, i.touchStart, e), Si(u, h, i.touchMove, e), a.interactivity.events.onClick.enable ? (Si(u, l, i.touchEndClick, e), Si(u, o, i.mouseUp, e), Si(u, s, i.mouseDown, e)) : Si(u, l, i.touchEnd, e), Si(u, t, i.mouseLeave, e), Si(u, d, i.touchCancel, e))
                ...
                const e = this._handlers,
                    ...
                    o = i.canvas.element;
                let r = n;
                "window" === s ? (i.interactivity.element = window, r = a) : i.interactivity.element = "parent" === s && o ? o.parentElement ? ? o.parentNode : o, this._manageMediaMatch(t), this._manageResize(t), this._manageInteractivityListeners(r, t), document && Si(document, p, e.visibilityChange, t, !1)
            }, this._manageMediaMatch = t => {
                const e = this._handlers,
                    i = X("(prefers-color-scheme: dark)");
                i && (void 0 === i.addEventListener ? void 0 !== i.addListener && (t ? i.addListener(e.oldThemeChange) : i.removeListener(e.oldThemeChange)) : Si(i, "change", e.themeChange, t))
            }, this._manageResize = t => {
                const e = this._handlers,
                    i = this.container;
                if (!i.actualOptions.interactivity.events.resize) return;
                if ("undefined" == typeof ResizeObserver) return void Si(window, u, e.resize, t);
    ...
    class Ti {
        constructor() {
            this.color = new zt, this.color.value = "", this.image = "", this.position = "", this.repeat = "", this.size = "", this.opacity = 1
        }
        load(t) {
            t && (void 0 !== t.color && (this.color = zt.create(this.color, t.color)), void 0 !== t.image && (this.image = t.image), void 0 !== t.position && (this.position = t.position), void 0 !== t.repeat && (this.repeat = t.repeat), void 0 !== t.size && (this.size = t.size), void 0 !== t.opacity && (this.opacity = t.opacity))
        }
    }
    class Ri {
        constructor() {
            this.color = new zt, this.color.value = "#fff", this.opacity = 1
        }
        load(t) {
            t && (void 0 !== t.color && (this.color = zt.create(this.color, t.color)), void 0 !== t.opacity && (this.opacity = t.opacity))
        }
    }
    class Di {
        constructor() {
            this.composite = "destination-out", this.cover = new Ri, this.enable = !1
        }
        load(t) {
            if (t) {
    ...
    class qi {
        constructor() {
            this.onClick = new Ii, this.onDiv = new Li, this.onHover = new Fi, this.resize = new Bi
        }
        get onclick() {
            return this.onClick
        }
        ...
        load(t) {
            ...
            void 0 !== e && (this.onDiv = dt(e, (t => {
                const e = new Li;
                return e.load(t), e
            }))), this.onHover.load(t.onHover ? ? t.onhover), gt(t.resize) ? this.resize.enable = t.resize : this.resize.load(t.resize)
        }
    }
    class Vi {
        constructor(t, e) {
    ...
    class Hi {
        constructor(t, e) {
            this.detectsOn = "window", this.events = new qi, this.modes = new Vi(t, e)
        }
        get detect_on() {
    ...
    class ji {
        constructor(t, e) {
            ...
            }, this._engine = t, this._container = e, this.autoPlay = !0, this.background = new Ti, this.backgroundMask = new Di, this.defaultThemes = {}, this.delay = 0, this.fullScreen = new Ei, this.detectRetina = !0, this.duration = 0, this.fpsLimit = 120, this.interactivity = new Hi(t, e), this.manualParticles = [], this.particles = Xe(this._engine, this._container), this.pauseOnBlur = !0, this.pauseOnOutsideViewport = !0, this.responsive = [], this.smooth = !1, this.style = {}, this.themes = [], this.zLayers = 100
        }
        get backgroundMode() {
        ...
        load(t) {
            if (!t) return;
            void 0 !== t.preset && dt(t.preset, (t => this._importPreset(t))), void 0 !== t.autoPlay && (this.autoPlay = t.autoPlay), void 0 !== t.delay && (this.delay = O(t.delay));
            const e = t.detectRetina ? ? t.retina_detect;
            void 0 !== e && (this.detectRetina = e), void 0 !== t.duration && (this.duration = O(t.duration));
    ...
    class Yi {
        constructor(t, e, i, s, o, n) {
            this.container = i, this._calcPosition = (t, e, i, s = 0) => {
                ...
                return e.straight || (t.angle += M(O(o.left, o.right))), e.random && "number" == typeof e.speed && (t.length *= _()), t
                ...
                return Math.floor(((this.roll.angle ? ? 0) + i) / (Math.PI / e)) % 2 ? this.backColor ? this.backColor : this.roll.alter ? Mi(t, this.roll.alter.type, this.roll.alter.value) : t : t
            }, this._initPosition = t => {
                const e = this.container,
                    i = P(this.options.zIndex.value);
                this.position = this._calcPosition(e, t, k(i, 0, e.zLayers)), this.initialPosition = this.position.copy();
                const s = e.canvas.size;
                switch (this.moveCenter = { ...mt(this.options.move.center, s),
        ...
        init(t, e, i, s) {
            ...
            const p = new Hi(n, o);
            p.load(o.actualOptions.interactivity), p.load(c.interactivity), this.interactivity = p, this.fill = u ? .fill ? ? c.shape.fill, this.close = u ? .close ? ? c.shape.close, this.options = c;
            const f = this.options.move.path;
            this.pathDelay = 1e3 * T(f.delay), f.generator && (this.pathGenerator = this._engine.plugins.getPathGenerator(f.generator), this.pathGenerator && o.addPath(f.generator, this.pathGenerator) && this.pathGenerator.init(o)), o.retina.initParticle(this), this.size = ft(this.options.size, a), this.bubble = {
                inRange: !1
            }, this.slow = {
                inRange: !1,
                factor: 1
            ...
            const v = o.particles;
            v.needsSort = v.needsSort || v.lastZIndex < this.position.z, v.lastZIndex = this.position.z, this.zIndexFactor = this.position.z / o.zLayers, this.sides = 24;
            let m = o.drawers.get(this.shape);
            m || (m = this._engine.plugins.getShapeDrawer(this.shape), m && o.drawers.set(this.shape, m)), m && m.loadShape && m.loadShape(this);
            const y = m ? .getSidesCount;
            y && (this.sides = y(this)), this.spawning = !1, this.shadowColor = Vt(this.options.shadow.color);
    ...
    class ts {
        constructor(t, e) {
            this.rectangle = t, this.capacity = e, this._subdivide = () => {
                ...
                for (let n = 0; n < 4; n++) this._subs.push(new ts(new Qi(t + i / 2 * (n % 2), e + s / 2 * (Math.round(n / 2) - n % 2), i / 2, s / 2), o));
                this._divided = !0
    ...
    const es = t => new Qi(-t.width / 4, -t.height / 4, 3 * t.width / 2, 3 * t.height / 2);
    class is {
        constructor(t, e) {
            this._applyDensity = (t, e, i) => {
                ...
                this.limit = s.limit * o, c < r ? this.push(Math.abs(r - c), void 0, t, i) : c > r && this.removeQuantity(c - r, i)
            ...
            }, this._engine = t, this._container = e, this._nextId = 0, this._array = [], this._zArray = [], this.pool = [], this.limit = 0, this.needsSort = !1, this.lastZIndex = 0, this._interactionManager = new Ni(t, e);
            const i = e.canvas.size;
            this.quadTree = new ts(es(i), 4), this.movers = this._engine.plugins.getMovers(e, !0), this.updaters = this._engine.plugins.getUpdaters(e, !0)
        }
        get count() {
        ...
        addManualParticles() {
            const t = this._container,
                e = t.actualOptions;
            for (const i of e.manualParticles) this.addParticle(i.position ? mt(i.position, t.canvas.size) : void 0, i.options)
        }
        addParticle(t, e, i, s) {
        ...
        async update(t) {
            ...
            for (const s of this._array) {
                ...
                s.destroyed ? i.add(s) : this.quadTree.insert(new Ji(s.getPosition(), s))
            }
            if (i.size) {
                const t = t => !i.has(t);
    ...
    class ss {
        ...
        init() {
            ...
            const s = e.particles,
                o = s.move;
            this.attractDistance = P(o.attract.distance) * i, this.maxSpeed = P(o.gravity.maxSpeed) * i, this.sizeAnimationSpeed = P(s.size.animation.speed) * i
        }
        initParticle(t) {
            const e = t.options,
                i = this.pixelRatio,
                ...
                o = s.distance,
                n = t.retina;
            n.attractDistance = P(s.attract.distance) * i, n.moveDrift = P(s.drift) * i, n.moveSpeed = P(s.speed) * i, n.sizeAnimationSpeed = P(e.size.animation.speed) * i;
    ...
    class rs {
        constructor(t, e, i) {
            ...
            }, this._engine = t, this.fpsLimit = 120, this.smooth = !1, this._delay = 0, this._duration = 0, this._lifeTime = 0, this._firstStart = !0, this.started = !1, this.destroyed = !1, this._paused = !0, this.lastFrameTime = 0, this.zLayers = 100, this.pageHidden = !1, this._sourceOptions = i, this._initialSourceOptions = i, this.retina = new ss(this), this.canvas = new Ci(this), this.particles = new is(this._engine, this), this.pathGenerators = new Map, this.interactivity = {
                mouse: {
                    clicking: !1,
                    inside: !1
                }
        ...
        addPath(t, e, i = !1) {
            return !(!os(this) || !i && this.pathGenerators.has(t)) && (this.pathGenerators.set(t, e ? ? as), !0)
        }
        alive() {
        ...
        pause() {
            if (os(this) && (void 0 !== this._drawAnimationFrame && (cancelAnimationFrame(this._drawAnimationFrame), delete this._drawAnimationFrame), !this._paused)) {
        ...
        async reset() {
            if (os(this)) return this._initialSourceOptions = void 0, this._options = ns(this._engine, this), this.actualOptions = ns(this._engine, this, this._options), this.refresh()
        }
        setNoise(t, e, i) {
        ...
        async start() {
            os(this) && !this.started && (await this.init(), this.started = !0, await new Promise((t => {
    ...
    class ds {
        constructor() {
            this._configs = new Map, this._domArray = [], this._eventDispatcher = new cs, this._initialized = !1, this.plugins = new hs(this)
        }
        get configs() {
            const t = {};
        ...
        addConfig(t, e) {
            bt(t) ? e && (e.name = t, this._configs.set(t, e)) : this._configs.set(t.name ? ? "default", t)
        }
        addEventListener(t, e) {
        ...
        async addShape(t, e, i, s, o, n = !0) {
            let a, r, c, l, h = n;
            gt(i) ? (h = i, r = void 0) : r = i, gt(s) ? (h = s, c = void 0) : c = s, gt(o) ? (h = o, l = void 0) : l = o, a = xt(e) ? {
                afterEffect: c,
                destroy: l,
                draw: e,
                init: r
        ...
        async loadFromArray(t, e, i) {
            ...
            return ! function(t) {
                ...
                var e
            }(t) ? (s = {}, bt(t) ? s.id = t : s.options = t, wt(e) ? s.index = e : s.options = e ? ? s.options, s.index = i ? ? s.index) : s = t, this._loadParams(s)
        }
        async loadJSON(t, e, i) {
            let s, o;
            return wt(e) || void 0 === e ? s = t : (o = t, s = e), this._loadParams({
                id: o,
                url: s,
                index: i
            })
        ...
        async set(t, e, i, s) {
            ...
            return bt(t) ? o.id = t : o.element = t, e instanceof HTMLElement ? o.element = e : o.options = e, wt(i) ? o.index = i : o.options = i ? ? o.options, this._loadParams(o)
        }
        ...
        async _loadParams(t) {
            const e = t.id ? ? `tsparticles${Math.floor(1e4*_())}`,
                ...
                n = o ? await async function(t) {
                    ...
                    return i.ok ? i.json() : ($().error(`${f} ${i.status} while retrieving config file`), t.fallback)
                }({
                    fallback: t.options,
                    url: o,
                    index: s
    ...
    class us {
        ...
        handleRangeColor(t) {
            const e = t.value.hsl ? ? t.value;
            if (void 0 !== e.h && void 0 !== e.l) return Nt({
                h: P(e.h),
                l: P(e.l),
                s: P(e.s)
            })
    ...
    class ms {
        static init(t) {
            ...
            return vs.set(i.replace(".", "").replace("!", ""), s, {
                fullScreen: {
                    enable: !1
                },
                particles: {
    ...
    const ys = t => {
        ...
        return window.particlesJS = e, window.pJSDom = i, window.Particles = ms, {
            particlesJS: e,
            pJSDom: i,
            Particles: ms
        }
    ...
    function gs(t, e, i, s, o, n) {
        ! function(t, e) {
            ...
            s.clamp && (t.velocity.x = k(t.velocity.x, -1, 1), t.velocity.y = k(t.velocity.y, -1, 1));
            ...
            s.spin.enable ? function(t, e) {
                ...
                function(t) {
                    const e = t.initialPosition,
                        ...
                        c = a.vertical;
                    if (r || c)
                        if ((r && o >= r || c && n >= c) && !t.misplaced) t.misplaced = !!r && o > r || !!c && n > c, r && (t.velocity.x = t.velocity.y / 2 - t.velocity.x), c && (t.velocity.y = t.velocity.x / 2 - t.velocity.y);
    ...
    class _s {
        ...
        init(t) {
            ...
            e && (t.color = ie(e, t.options.color.animation, this.container.retina.reduceFactor))
        }
        isEnabled(t) {
            const {
                h: e,
        ...
        update(t, e) {
            ! function(t, e) {
                ...
                a && xs(e, a, i, 360, !1), r && xs(e, r, s, 100, !0), c && xs(e, c, o, 100, !0)
            }(t, e)
        }
    }
    class ks {
            ...
            this.isEnabled(t) && function(t, e) {
                ...
                if (i.time || (i.time = 0), (i.delayTime ? ? 0) > 0 && i.time < (i.delayTime ? ? 0) && (i.time += e.value), !((i.delayTime ? ? 0) > 0 && i.time < (i.delayTime ? ? 0))) {
                    ...
                    i.velocity && 1 !== i.decay && (i.velocity *= n),
                        ...
                        }(t, i.value, s, o), t.destroyed || (i.value = k(i.value, s, o))
                }
            }(t, e)
        }
    }
    ...
    class Ms {
        ...
        update(t, e, i, s) {
            ...
            switch (t.outType) {
                case "normal":
                case "outside":
                    if (tt(t.position, o.canvas.size, m.origin, t.getRadius(), e)) return;
                    break;
                case "inside":
                    {
                        const {
    ...
    class Ps {
        ...
        update(t, e, i, s) {
            ...
            if (o.enable) {
                ...
                tt(t.position, n.canvas.size, m.origin, r, e) || n.particles.remove(t)
            }
        }
    }
    class Cs {
                ...
                case "inside":
                    {
                        ...
                        s = m.origin;s.length = t.moveCenter.radius,
                        ...
                        if (e <= 0 && n >= 0 || i <= 0 && a >= 0 || e >= 0 && n <= 0 || i >= 0 && a <= 0) return;t.position.x = Math.floor(M({
                            min: 0,
                            max: o.canvas.size.width
                        })),
                        t.position.y = Math.floor(M({
                            min: 0,
                        ...
                        const {
                            dx: r,
                            dy: c
                        } = R(t.position, t.moveCenter);t.direction = Math.atan2(-c, -r),
                        ...
                        case "outside":
                            {
                                ...
                                const {
                                    dx: e,
                                    dy: i
                                } = R(t.position, t.moveCenter);t.moveCenter.radius && (t.direction = Math.atan2(i, e), t.velocity.angle = t.direction);
                                break
                            }
                        case "normal":
                            {
            ...
            this.isEnabled(t) && function(t, e) {
                ...
                if (i.time || (i.time = 0), (i.delayTime ? ? 0) > 0 && i.time < (i.delayTime ? ? 0) && (i.time += e.value), !((i.delayTime ? ? 0) > 0 && i.time < (i.delayTime ? ? 0))) {
                    ...
                    i.velocity && 1 !== a && (i.velocity *= a),
                        ...
                        }(t, i.value, o, n), t.destroyed || (i.value = k(i.value, o, n))
                }
            }(t, e)
        }
    }
    ...
    class Ds extends li {
        constructor(t, e) {
            super(e), this._clickAttract = () => {
                ...
                if (e.finish || (e.count || (e.count = 0), e.count++, e.count === t.particles.count && (e.finish = !0)), e.clicking) {
                ...
                const t = this.container,
                    ...
                    i = t.retina.attractModeDistance;
                !i || i < 0 || !e || this._processAttract(e, i, new Ki(e.x, e.y, i))
                ...
                for (const i of n) {
                    const {
                        ...
                        dy: n,
                        distance: a
                    } = R(i.position, t), r = o.speed * o.factor, c = k(w(o.easing)(1 - a / e) * r, 0, o.maxSpeed), l = m.create(0 === a ? r : s / a * c, 0 === a ? r : n / a * c);
                    i.position.subFrom(l)
                }
            }, this._engine = t, e.attract || (e.attract = {
                particles: []
        ...
        async interact() {
            const t = this.container,
                ...
                a = s.onClick.enable,
                c = s.onClick.mode;
            i && o && J("attract", n) ? this._hoverAttract() : a && J("attract", c) && this._clickAttract()
        }
        isEnabled(t) {
            const e = this.container,
                i = e.actualOptions,
    ...
    class Is extends li {
        constructor(t) {
            super(t), this._processBounce = (t, e, i) => {
                const s = this.container.particles.quadTree.query(i, (t => this.isEnabled(t)));
                for (const o of s) i instanceof Ki ? lt(ct(o), {
                    position: t,
                    radius: e,
                    mass: e ** 2 * Math.PI / 2,
                    velocity: m.origin,
                ...
                !s || s < 0 || !i || this._processBounce(i, s, new Ki(i.x, i.y, s + e))
                ...
                s.length && s.forEach((t => {
                    const s = t,
                        ...
                        a = s.offsetWidth / 2 * o,
                        r = 10 * o,
                        c = "circle" === e.type ? new Ki(n.x, n.y, a + r) : new Qi(s.offsetLeft * o - r, s.offsetTop * o - r, s.offsetWidth * o + 2 * r, s.offsetHeight * o + 2 * r);
        ...
        async interact() {
            const t = this.container,
                ...
                o = e.onHover.mode,
                n = e.onDiv;
            i && s && J("bounce", o) ? this._processMouseBounce() : nt("bounce", n, ((t, e) => this._singleSelectorBounce(t, e)))
        }
        isEnabled(t) {
            const e = this.container,
                i = e.actualOptions,
                ...
                o = (t ? .interactivity ? ? i.interactivity).events,
                n = o.onDiv;
            return s.position && o.onHover.enable && J("bounce", o.onHover.mode) || ot("bounce", n)
        }
        loadModeOptions(t, ...e) {
    ...
    class Fs extends Ls {
        load(t) {
            super.load(t), t && (this.divs = dt(t.divs, (t => {
                const e = new As;
                return e.load(t), e
            })))
        }
    ...
    class qs extends li {
        constructor(t) {
            super(t), this._clickBubble = () => {
                ...
                if (o) {
                    ...
                    if (t.bubble.finalColor)
                        if (o.mix) {
                            ...
                            t.bubble.color = i ? $t(Qt(i, t.bubble.finalColor, 1 - e, e)) : t.bubble.finalColor
                ...
                const r = a.duration,
                    ...
                    u = s.type;
                if (c && !(c < 0) && n !== l)
                    if (o.bubble || (o.bubble = {}), o.bubble.durationEnd) h && ("size" === u && delete t.bubble.radius, "opacity" === u && delete t.bubble.opacity);
                    else if (e <= c) {
                    if ((h ? ? d) !== n) {
                        const e = d - i * (d - n) / r;
                        "size" === u && (t.bubble.radius = e), "opacity" === u && (t.bubble.opacity = e)
                    }
                } else "size" === u && delete t.bubble.radius, "opacity" === u && delete t.bubble.opacity
                ...
                n && o.length && o.forEach((e => {
                    const o = e,
                        ...
                        c = o.offsetWidth / 2 * a,
                        l = "circle" === i.type ? new Ki(r.x, r.y, c) : new Qi(o.offsetLeft * a, o.offsetTop * a, o.offsetWidth * a, o.offsetHeight * a),
        ...
        async interact(t) {
            const e = this.container.actualOptions.interactivity.events,
                ...
                r = s.mode,
                c = e.onDiv;
            o && J("bubble", n) ? this._hoverBubble() : a && J("bubble", r) ? this._clickBubble() : nt("bubble", c, ((e, i) => this._singleSelectorHover(t, e, i)))
        }
        isEnabled(t) {
            const e = this.container,
                i = e.actualOptions,
                ...
                c = ot("bubble", a);
            return !!(c || r.enable && s.position || n.enable && s.clickPosition) && (J("bubble", r.mode) || J("bubble", n.mode) || c)
        }
        loadModeOptions(t, ...e) {
    ...
    class Hs {
        ...
        load(t) {
            t && (void 0 !== t.distance && (this.distance = t.distance), this.links.load(t.links ? ? t.lineLinked ? ? t.line_linked), void 0 !== t.radius && (this.radius = t.radius))
        }
    }
    ...
    function Us(t, e, i, s) {
        ...
        if (o) return function(t, e, i, s) {
            ...
            return h.addColorStop(0, Zt(n, s)), h.addColorStop(o > 1 ? 1 : o, Jt(l, s)), h.addColorStop(1, Zt(a, s)), h
    ...
    class $s extends li {
        ...
        isEnabled(t) {
            ...
            return !(!s.onHover.enable || !i.position) && J("connect", s.onHover.mode)
        }
        loadModeOptions(t, ...e) {
    ...
    class Gs {
        ...
        load(t) {
            t && (void 0 !== t.blink && (this.blink = t.blink), void 0 !== t.color && (this.color = zt.create(this.color, t.color)), void 0 !== t.consent && (this.consent = t.consent), void 0 !== t.opacity && (this.opacity = t.opacity))
        }
    }
    class js {
        constructor() {
        ...
        load(t) {
            t && (void 0 !== t.distance && (this.distance = t.distance), this.links.load(t.links ? ? t.lineLinked ? ? t.line_linked))
        }
    }
    ...
    function Ns(t, e, i, s, o) {
        t.canvas.draw((t => {
            ...
            ! function(t, e, i, s, o, n) {
                vi(t, i, s), t.strokeStyle = Jt(o, n), t.lineWidth = e, t.stroke()
    ...
    class so extends li {
        constructor(t, e) {
            super(e), this._clickRepulse = () => {
                ...
                if (i.finish || (i.count || (i.count = 0), i.count++, i.count === t.particles.count && (i.finish = !0)), i.clicking) {
                    ...
                    for (const t of r) {
                        const {
                            ...
                            dy: a,
                            distance: r
                        } = R(n, t.position), c = r ** 2, l = -o * e.speed / c;
                        if (c <= o) {
                            i.particles.push(t);
                ...
                !i || i < 0 || !e || this._processRepulse(e, i, new Ki(e.x, e.y, i))
                ...
                if (a)
                    for (const i of n) {
                        const {
                            ...
                            dy: n,
                            distance: r
                        } = R(i.position, t), c = (s ? .speed ? ? a.speed) * a.factor, l = k(w(a.easing)(1 - r / e) * c, 0, a.maxSpeed), h = m.create(0 === r ? c : o / r * l, 0 === r ? c : n / r * l);
                        i.position.addTo(h)
                    }
                ...
                o.length && o.forEach((t => {
                    const o = t,
                        ...
                        r = o.offsetWidth / 2 * n,
                        c = "circle" === e.type ? new Ki(a.x, a.y, r) : new Qi(o.offsetLeft * n, o.offsetTop * n, o.offsetWidth * n, o.offsetHeight * n),
                        l = rt(s.divs, o);
        ...
        async interact() {
            const t = this.container,
                ...
                h = c.mode,
                d = s.onDiv;
            i && n && J("repulse", a) ? this._hoverRepulse() : l && J("repulse", h) ? this._clickRepulse() : nt("repulse", d, ((t, e) => this._singleSelectorRepulse(t, e)))
        }
        isEnabled(t) {
            const e = this.container,
                i = e.actualOptions,
                    ...
                    if (l) {
                            ...
                            if (ao[l] < a.height)
                                for (let t = 0, e = 0;;) {
                                    ...
                                    if (i = m(r, o), r += o + 1, i === v) {
                                        o = p + 1, c.length = v + 2;
                                        for (let t = 0; t < c.length; t++) c[t] = t < v ? [t] : []
                                    } else {
                                        i >= c.length ? c.push(c[s].concat(c[s][0])) : s !== v && c.push(c[s].concat(c[i][0]));
                                        for (let s = 0; s < c[i].length; s++) {
                                            ...
                                            u.data.set([o, n, r, h], ao[l] * a.width + ro[l] * e + t % (4 * a.width)), t += 4
                                        }
                                        c.length === 1 << o && o < 12 && o++
                                    }
                                    if (t === 4 * a.width * (e + 1) && (e++, ao[l] + ro[l] * e >= a.height)) break
                                }
                        ...
                        for (let t = 0, e = p + 1, i = 0, s = [
                            ...
                            if (t = m(i, e), i += e, t === v) {
                                ...
                                if (t === v + 1) break;
                                t >= s.length ? s.push(s[n].concat(s[n][0])) : n !== v && s.push(s[n].concat(s[t][0]));
    ...
    const uo = /(#(?:[0-9a-f]{2}){2,4}|(#[0-9a-f]{3})|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d.]+%?\))|currentcolor/gi;
    async function po(t) {
        return new Promise((e => {
            ...
            t.element = i, i.addEventListener("load", (() => {
                ...
                t.element = void 0, t.error = !0, t.loading = !1, $().error(`${f} loading image: ${t.source}`), e()
            })), i.src = t.source
        }))
    }
    async function fo(t) {
        if ("gif" === t.type) {
            ...
            try {
                t.gifData = await async function(t, e, i) {
                    ...
                    const l = 1 << 1 + (7 & r),
                        h = a.nextByte();
                    n.pixelAspectRatio = a.nextByte(), 0 !== n.pixelAspectRatio && (n.pixelAspectRatio = (n.pixelAspectRatio + 15) / 64), c && (n.globalColorTable = lo(a, l));
                    const d = (() => {
                        try {
                    ...
                    try {
                        ...
                        if (t instanceof EvalError) throw new Error(`error while parsing frame ${v} "${t.message}"`);
                        throw t
                    }
    ...
    async function vo(t) {
        ...
        e.ok ? t.svgData = await e.text() : ($().error(`${f} Image not found`), t.error = !0), t.loading = !1
    }
    ...
    class yo {
        ...
        draw(t, e, i, s, o) {
            ...
            if (n) {
                if (t.globalAlpha = s, n.gif && n.gifData) {
                    ...
                    switch (t.scale(i / n.gifData.width, i / n.gifData.height), l.disposalMethod) {
                        case 4:
                        case 5:
                        case 6:
                        case 7:
                        case 0:
                            a.drawImage(l.bitmap, l.left, l.top), t.drawImage(s, c.x, c.y), a.clearRect(0, 0, s.width, s.height);
                            break;
                        case 1:
                            a.drawImage(l.bitmap, l.left, l.top), t.drawImage(s, c.x, c.y);
                            break;
                        case 2:
                            a.drawImage(l.bitmap, l.left, l.top), t.drawImage(s, c.x, c.y), a.clearRect(0, 0, s.width, s.height), 0 === n.gifData.globalColorTable.length ? a.putImageData(n.gifData.frames[0].image, c.x + l.left, c.y + l.top) : a.putImageData(n.gifData.backgroundImage, c.x, c.y);
                            break;
                        case 3:
                            {
                                const e = a.getImageData(0, 0, s.width, s.height);a.drawImage(l.bitmap, l.left, l.top),
                    ...
                    if (e.gifTime += o.value, e.gifTime > l.delayTime) {
                        if (e.gifTime -= l.delayTime, ++r >= n.gifData.frames.length) {
        ...
        particleInit(t, e) {
            ...
            n.loading ? setTimeout((() => {
                ...
                let t;
                t = n.svgData && o ? await mo(n, s, o, e) : {
                    color: o,
                    data: n,
                    element: n.element,
                    gif: n.gif,
    ...
    async function wo(t, e = !0) {
        ...
        const i = new bo(t);
        await t.addPlugin(i, e), await t.addShape(["image", "images"], new yo(t), e)
    }
    class xo extends St {
        constructor() {
            super(), this.sync = !1
    ...
    class zo {
        ...
        update(t, e) {
            ...
            const o = this.container.canvas.size,
                n = O(0, o.width),
                a = O(0, o.width);
            t.position.x = M(n), t.position.y = M(a), t.spawning = !0, i.delayTime = 0, i.time = 0, t.reset();
    ...
    class Po {
        init() {}
        isEnabled(t) {
            return !j() && !t.destroyed && t.container.actualOptions.interactivity.events.onHover.parallax.enable
        }
        move(t) {
            const e = t.container,
    ...
    function So(t, e, i, s, o, n) {
        ...
        t.size.value += a / 2, i.size.value -= a, s <= n && (i.size.value = 0, i.destroy())
    }
    const Oo = t => {
        void 0 === t.collisionMaxSpeed && (t.collisionMaxSpeed = P(t.options.collisions.maxSpeed)), t.velocity.length > t.collisionMaxSpeed && (t.velocity.length = t.collisionMaxSpeed)
    };
        ...
        switch (t.options.collisions.mode) {
            case "absorb":
                ! function(t, e, i, s) {
                    const o = t.getRadius(),
                        n = e.getRadius();
                    void 0 === o && void 0 !== n ? t.destroy() : void 0 !== o && void 0 === n ? e.destroy() : void 0 !== o && void 0 !== n && (o >= n ? So(t, 0, e, n, i, s) : So(e, 0, t, o, i, s))
                }(t, e, i, s);
                break;
            case "bounce":
                To(t, e);
            ...
            case "destroy":
                ! function(t, e) {
                    t.unbreakable || e.unbreakable || To(t, e), void 0 === t.getRadius() && void 0 !== e.getRadius() ? t.destroy() : void 0 !== t.getRadius() && void 0 === e.getRadius() ? e.destroy() : void 0 !== t.getRadius() && void 0 !== e.getRadius() && (t.getRadius() >= e.getRadius() ? e : t).destroy()
                }(t, e)
        }
    }
    class Do extends fs {
    ...
    class Io {
        constructor() {
            this.blur = 5, this.color = new zt, this.color.value = "#000", this.enable = !1
        }
        load(t) {
            t && (void 0 !== t.blur && (this.blur = t.blur), this.color = zt.create(this.color, t.color), void 0 !== t.enable && (this.enable = t.enable))
        }
    }
    class Lo {
        constructor() {
        ...
        load(t) {
            t && (void 0 !== t.color && (this.color = zt.create(this.color, t.color)), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.frequency && (this.frequency = t.frequency), void 0 !== t.opacity && (this.opacity = t.opacity))
        }
    }
    class Ao {
        constructor() {
            this.blink = !1, this.color = new zt, this.color.value = "#fff", this.consent = !1, this.distance = 100, this.enable = !1, this.frequency = 1, this.opacity = 1, this.shadow = new Io, this.triangles = new Lo, this.width = 1, this.warp = !1
        }
        load(t) {
            t && (void 0 !== t.id && (this.id = t.id), void 0 !== t.blink && (this.blink = t.blink), this.color = zt.create(this.color, t.color), void 0 !== t.consent && (this.consent = t.consent), void 0 !== t.distance && (this.distance = t.distance), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.frequency && (this.frequency = t.frequency), void 0 !== t.opacity && (this.opacity = t.opacity), this.shadow.load(t.shadow), this.triangles.load(t.triangles), void 0 !== t.width && (this.width = t.width), void 0 !== t.warp && (this.warp = t.warp))
        }
    }
    ...
    class Bo extends fs {
        constructor(t) {
            super(t), this._setColor = t => {
                ...
                if (s) return;
                s = te(i.color, i.blink, i.consent), void 0 === i.id ? e.particles.linksColor = s : e.particles.linksColors.set(i.id, s)
        ...
        loadParticlesOptions(t, ...e) {
            ...
            for (const i of e) t.links.load(i ? .links ? ? i ? .lineLinked ? ? i ? .line_linked)
        }
        reset() {}
    }
    ...
    class Vo {
        constructor(t) {
            this.container = t, this._drawLinkLine = (t, e) => {
                ...
                s.canvas.draw((e => {
                    ...
                    ! function(t) {
                        ...
                        if (!e) return;
                        n.lineWidth = r, c.enable && (n.globalCompositeOperation = c.composite), n.strokeStyle = Jt(l, h);
                        const {
                            shadow: u
                        } = d;
                        if (u.enable) {
                ...
                l <= 0 || n.canvas.draw((e => {
                    ...
                    p && function(t) {
                        ...
                        mi(e, i, s, o), n.enable && (e.globalCompositeOperation = n.composite), e.fillStyle = Jt(a, r), e.fill()
                    }({
                        context: e,
                        pos1: i,
                        pos2: h,
            ...
            }, this._getLinkFrequency = (t, e) => qo([t, e], this._freqs.links), this._getTriangleFrequency = (t, e, i) => qo([t, e, i], this._freqs.triangles), this._freqs = {
                links: new Map,
                triangles: new Map
            }
        }
        drawParticle(t, e) {
            ...
            const o = i.filter((t => s.links && this._getLinkFrequency(e, t.destination) <= s.links.frequency));
    ...
    class Wo {
        draw(t, e, i) {
            ...
            if (t) {
                ...
                for (let e = 0; e < n; e++) t.lineTo(o.length, 0), t.translate(o.length, 0), t.rotate(c)
            }
        }
        getSidesCount(t) {
            const e = t.shapeData;
    ...
    class No {
        ...
        load(t) {
            t && (void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.speed && (this.speed = O(t.speed)), void 0 !== t.decay && (this.decay = O(t.decay)), void 0 !== t.sync && (this.sync = t.sync))
        }
    }
    class Xo extends St {
        constructor() {
            super(), this.animation = new No, this.direction = "clockwise", this.path = !1, this.value = 0
        }
        load(t) {
    ...
    class tn {
        ...
        init(t) {
            ...
            t.strokeWidth = P(s.width) * e.retina.pixelRatio, t.strokeOpacity = P(s.opacity ? ? 1), t.strokeAnimation = s.color ? .animation;
        ...
        update(t, e) {
            this.isEnabled(t) && function(t, e) {
                ...
                i && Ko(e, i, n, 360, !1), s && Ko(e, s, a, 100, !0), o && Ko(e, o, r, 100, !0)
            }(t, e)
        }
    }
    ...
    class sn {
        ...
        async init(t) {
            ...
            if (en.find((t => J(t, e.particles.shape.type)))) {
                const t = en.map((t => e.particles.shape.options[t])).find((t => !!t)),
                    i = [];
                dt(t, (t => {
    ...
    async function on(t, e = !0) {
        ys(t), await async function(t, e = !0) {
        ...
        }(t, !1), await Uo(t, !1), await async function() {
            b("ease-in-quad", (t => t ** 2)), b("ease-out-quad", (t => 1 - (1 - t) ** 2)), b("ease-in-out-quad", (t => t < .5 ? 2 * t ** 2 : 1 - (-2 * t + 2) ** 2 / 2))
        }(), await wo(t, !1), await async function(t, e = !0) {
            await t.addShape("line", new Mo, e)
        }(t, !1), await jo(t, !1), await async function(t, e = !0) {
    ...
    class an extends St {
        constructor() {
            super(), this.animation = new nn, this.direction = "clockwise", this.enable = !1, this.value = 0
        }
        load(t) {
    ...
    class cn {
        ...
        load(t) {
            t && (void 0 !== t.color && (this.color = zt.create(this.color, t.color)), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.frequency && (this.frequency = t.frequency), void 0 !== t.opacity && (this.opacity = O(t.opacity)))
        }
    }
    class ln {
        constructor() {
    ...
    class dn {
        ...
        load(t) {
            t && (void 0 !== t.angle && (this.angle = O(t.angle)), void 0 !== t.move && (this.move = O(t.move)))
        }
    }
    class un {
        constructor() {
        ...
        load(t) {
            if (t && (void 0 !== t.distance && (this.distance = O(t.distance)), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.speed))
                if (wt(t.speed)) this.speed.load({
                    angle: t.speed
                });
                else {
                    const e = t.speed;
    ...
    async function fn(t, e = !0) {
        await async function(t, e = !0) {
            ...
            t.emitterShapeManager || (t.emitterShapeManager = new ni(t)), t.addEmitterShape || (t.addEmitterShape = (e, i) => {
                t.emitterShapeManager ? .addShape(e, i)
            });
            const i = new ci(t);
            await t.addPlugin(i, e), t.addEmitterShape("circle", new Ze), t.addEmitterShape("square", new ri)
        }(t, !1), await on(t, e)
    }
    return fn(vs), e
})()));